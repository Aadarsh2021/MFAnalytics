...
import { downloadReport } from '../../utils/data/export.js'
import { supabase } from '../../utils/api/supabase'
import BacktestingPanel from '../analysis/BacktestingPanel'
import BacktestResults from '../analysis/BacktestResults'
import RegimeAllocationChart from '../dashboard/RegimeAllocationChart'
import RegimeAlertModal from '../modals/RegimeAlertModal'
import { REGIMES } from '../../config/regimeConfig'
import { mapFundsToAssetClasses, calculateAssetClassWeights } from '../../utils/funds/assetClassUtils'
import { detectRegime } from '../../utils/regime/regimeDetector'
